...
# ----------------------------- INPUTS
# STRUCTURE
STR_DATA_FILE_LOC="$DATA_LOC/Ebrahimi_3_3_2026_subsets/3_subsampled_top10_loci200.str"
...
# NEWHYBRIDS
NH_DATA_FILE_LOC="$DATA_LOC/Ebrahimi_3_3_2026_subsets/3_subsampled_top10_loci200.nh"
