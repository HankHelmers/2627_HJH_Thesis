...
# ----------------------------- INPUTS
# STRUCTURE
STR_DATA_FILE_LOC="$DATA_LOC/Ebrahimi_3_3_2026_subsets/5_200_loci_randomized_subsample_top10.str"
...
# NEWHYBRIDS
NH_DATA_FILE_LOC="$DATA_LOC/Ebrahimi_3_3_2026_subsets/5_200_loci_randomized_subsample_top10.nh"
GENOTYPE_LOC="$SCRIPTS_LOC/data_generation/genotype_cat_f1"

# Experimental inputs 
NUMINDS=10       # wc -l ebrahimi_3_3.bim
NUMLOCI=200
LABEL=1
MISSING=-9
