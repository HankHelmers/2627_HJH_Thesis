#
# Full pipeline to generate subsampled, randomized subsets of haplotypes 
# from March 2026 Ebrahimi data.
#
...
PREPARED_OUTPUT_PATH="$DATA_LOC/Ebrahimi_3_3_2026_subsets_labeled" #[insert output path]

JC_JA_LABELS_FILE="$DATA_LOC/Ebrahimi_3_3_2026_prepared/JA_JC_labels.txt"
...
"$SCRIPTS_LOC/data_preparation/vcf_inds_rename_with_label.sh" \
    $INPUT_VCF_FILE \
    $PREPARED_OUTPUT_PATH \
    $RENAMED_VCF_FILE_1 \
    $JC_JA_LABELS_FILE  #1_renamed_inds_original.vcf
